...
│
├── agent/                      # 推销员端文档
│   └── AGENT_MINIPROGRAM_MANUAL.md  # v3.1 含42个路由
│
├── store/                      # 门店端文档
│   └── STORE-GUIDE.md          # v2.1 含14个路由
│
├── admin/                      # 管理后台文档
│   └── ADMIN-GUIDE.md          # v3.1 含47个路由
│
├── server/                     # 后端文档
│   ├── API_REFERENCE.md        # v2.1 210+个API端点
│   ├── DATABASE.md             # v2.1 75个数据表
...
| 端 | 文档 | 版本 | 路由数 |
|----|------|------|--------|
| 推销员端 | agent/AGENT_MINIPROGRAM_MANUAL.md | v3.1 | 42 |
| 门店端 | store/STORE-GUIDE.md | v2.1 | 14 |
| 管理后台 | admin/ADMIN-GUIDE.md | v3.1 | 47 |

### 后端技术文档 (server/)

| 文档 | 说明 | 数量 |
|------|------|------|
| API_REFERENCE.md | API端点参考 | 210+ |
| DATABASE.md | 数据表详细说明 | 75表 |
...
### 2026-01-27
- [新增] 套餐功能相关文档（11个API + 3个数据表）
- [更新] API参考文档升级到v2.1（210+ API）
- [更新] 数据库文档升级到v2.1（75表）
- [更新] 推销员端手册升级到v3.1（+套餐模块详解）
- [更新] 管理后台手册升级到v3.1（+套餐管理）
- [更新] 门店端手册升级到v2.1（+套餐库存管理）
- [更新] 业务手册新增套餐销售章节
- [更新] 变更日志新增套餐功能记录
